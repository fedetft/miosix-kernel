...
#define MyAppVersion "GCC 15.2.0mp4.0"
...
AllowNoIcons=yes
; Produce an installer named MiosixToolchainInstaller15.2.0mp4.0.exe
OutputBaseFilename=MiosixToolchainInstaller15.2.0mp4.0
Compression=lzma
