...
#define MyAppVersion "GCC 14.2.0mp4.0"
...
AllowNoIcons=yes
; Produce an installer named MiosixToolchainInstaller14.2.0mp4.0.exe
OutputBaseFilename=MiosixToolchainInstaller14.2.0mp4.0
Compression=lzma
