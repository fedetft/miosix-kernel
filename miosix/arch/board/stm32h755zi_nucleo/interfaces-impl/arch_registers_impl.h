...
//On stm32h745,h755,h747,h757 RCC synchronization is required per the reference
//manual (RM0399 section 9.5.10, although the synchonization mechanism described
//is different).
