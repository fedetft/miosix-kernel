 ...
 * startup.cpp
 * STM32 C++ startup.
 * NOTE: for stm32h755 devices ONLY.
...
void __attribute__((weak)) CM7_SEV_IRQHandler();
void __attribute__((weak)) CM4_SEV_IRQHandler();
...
void __attribute__((weak)) HSEM2_IRQHandler();
